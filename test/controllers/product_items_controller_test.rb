...
class ProductItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_item" do
    assert_difference('ProductItem.count') do
      post product_items_url, params: { product_item: { category_id: @product_item.category_id, ingridient_id: @product_item.ingridient_id, product_id: @product_item.product_id } }
    end
  ...
  test "should update product_item" do
    patch product_item_url(@product_item), params: { product_item: { category_id: @product_item.category_id, ingridient_id: @product_item.ingridient_id, product_id: @product_item.product_id } }
