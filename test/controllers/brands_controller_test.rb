...
class BrandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brand" do
    assert_difference('Brand.count') do
      post brands_url, params: { brand: { product_id: @brand.product_id, title: @brand.title } }
    end
  ...
  test "should update brand" do
    patch brand_url(@brand), params: { brand: { product_id: @brand.product_id, title: @brand.title } }
